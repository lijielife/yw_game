...
<script type="text/ecmascript-6">
  export default {
    props: {
      getType: '' // getGold, getScore, goldNull
    },
    methods: {
      _close () {
...
<style scoped>
  ...
  .alert-dialog .alert-con .conImg{
    width: 361rpx;
    height: 431rpx;
    display: block;
    margin: 0 auto;
  }
  .alert-dialog .alert-con p.text{
    font-size: 32rpx;
    text-align: center;
    color: #ffffff;
  ...
  .alert-dialog .alert-con .btn img{
    width: 100%;
    height: 100%;
  }
  @keyframes zoomInUp {
  ...
  .zoomInDown {
    animation: zoomInDown 0.5s linear;
  }
</style>
